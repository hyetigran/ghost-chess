...
- **Open**: physical-device push delivery unverified (needs an EAS device build); a deliberate migration-history strategy for any remote DB that applied the pre-squash migration chain.
